...
export class ObjectManipulator {
    ...
    public set(key: string, value: number): object {
...
type mapperType = (a: string) => void;

export function map(mapper: mapperType, input: any[]): Function | any[]{
...
type filterType = (a: string) => void;

export function filter(filterer: filterType, input: any[]): Function | any[]{
    if (arguments.length === 0) {
        return filter;
    }
    if (arguments.length === 1) {
